...
if __name__=="__main__":
    ...
    for analysis, comorbidities in zip(["bmi_cat", "comorbid"], comorbid_list):
        ...
        enrich_file = os.path.join(PROJECT_DIR, f"data/enrichment/{analysis}/monogenic_enrich_{analysis}.csv")
        enrich_df.to_csv(enrich_file, index=False)
        sig_enrich_file = os.path.join(PROJECT_DIR, f"data/enrichment/{analysis}/monogenic_enrich_{analysis}_sig.csv")
